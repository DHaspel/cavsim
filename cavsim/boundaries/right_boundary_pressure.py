...
class RightBoundaryPressure(BaseBoundary):
    """
    ...
    def prepare_next_timestep(self, delta_t: float, next_total_time: float) -> None:
        ...
        self._pressure[0, 1] = self._boundary(next_total_time) if callable(self._boundary) else self._boundary
